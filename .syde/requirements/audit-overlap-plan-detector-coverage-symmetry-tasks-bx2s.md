...
id: REQ-0409
kind: requirement
name: 'Audit overlap plan: detector + coverage + symmetry tasks'
slug: audit-overlap-plan-detector-coverage-symmetry-tasks-bx2s
relationships:
...
statement: The syde design model shall trace detector + coverage + symmetry cleanup tasks back to the audit-overlap plan via this scoped requirement.
req_type: constraint
priority: must
